package top.zrwang.week02.service;
...
import top.zrwang.week02.entity.Phone;
import top.zrwang.week02.entity.Student;
...
public class StudentService {
    ...
    static {
        ...
        Student student2 = Student.builder()
                ...
                .phone(Phone.builder().band("huawei").price(5999.99).color("white").build())
                .build();
